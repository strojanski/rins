...
(cl:defmethod cl:initialize-instance :after ((m <Message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hw_1-msg:<Message> is deprecated: use hw_1-msg:Message instead.")))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hw_1-msg:message-val is deprecated.  Use hw_1-msg:message instead.")
  (message m))

(cl:ensure-generic-function 'sid-val :lambda-list '(m))
(cl:defmethod sid-val ((m <Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hw_1-msg:sid-val is deprecated.  Use hw_1-msg:sid instead.")
  (sid m))
